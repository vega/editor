...
import { Code, Copy, ExternalLink, FileText, Github, Grid, Image, Link, Map, Play, Trash2, X } from 'react-feather';
...
class Header extends React.Component<Props, State> {
  ...
  public exportURL() {
    ...
    if (serializedSpec) {
      if (this.props.history.location.pathname.indexOf(serializedSpec) === -1) {
      ...
      <div className="export-content">
        ...
        <div className="export-buttons">
          ...
          <button className="export-button" onClick={() => this.exportURL()}>
            ...
            <p>
              A URL will be generated by compressing the spec, keeping the indentations. This special URL is publically
              shareable.
            </p>
          </button>
        </div>
        ...
        <div className="exported-url">
          <span ref="exportedURL">Click on URL button to get a shareable link</span>
          <Clipboard
            className="copy-icon"
            data-clipboard-text={this.state.exportURL}
            button-title="Copy"
